...
(function() {
  ...
  SolverDataController.$inject = ['$location', '$timeout'];

  function SolverDataController($location, $timeout) {
    var vm = this;
    vm.changeOut = changeOut;
    vm.goLoader = goLoader;
          ...
          if (newV > oldV) {
            for (var i = oldV; i < vm.boundariesValues.length; i++) {
              vm.boundariesValues[i] = {
                ...
                boundaries: [{
                  type: 'text',
                  placeholder: 'x_1 гран',
                  value: ''
                }, {
                  type: 'text',
                  placeholder: 'x_2 гран',
                  value: ''
                }, {
                  type: 'text',
                  placeholder: 'T гран',
  ...
  HelpersService.$inject = ['$location', '$anchorScroll'];
  ...
  CheckboxDirective.$inject = ['helpers'];

  function CheckboxDirective(helpers) {
    return {
      restrict: 'AE',
      replace: false,
  ...
  InputsDirective.$inject = ['helpers'];

  function InputsDirective(helpers) {
    return {
      restrict: 'AE',
      replace: false,
